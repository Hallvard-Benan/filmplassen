...
const ImageSlider = () => {
  const squares = [
    ...
    },
    {
      image: images[4],
      size: "w-48 h-32",
      position: { top: "40vh", left: "30vw" },
    },
    {
      image: images[8],
      size: "w-64 h-36",
      position: { top: "60vh", left: "32vw" },
    },
    {
      image: images[1],
      size: "w-64 h-48",
      position: { top: "25vh", left: "50vw" },
    },
    {
      image: images[5],
      size: "w-56 h-36",
    ...
    },
    {
      image: images[6],
      size: "w-36 h-28",
      position: { top: "35vh", left: "75vw" },
    },
    {
      image: images[10],
      size: "w-56 h-40",
      position: { top: "60vh", left: "75vw" },
    },
  ];

  return (
    <div className="absolute top-0 left-0 w-full h-full max-w-5xl mx-auto">
